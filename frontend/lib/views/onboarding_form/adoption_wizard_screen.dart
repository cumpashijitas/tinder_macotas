...
class AdoptionWizardScreen extends StatelessWidget {
  const AdoptionWizardScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => AdopterFormController(),
      child: Consumer<AdopterFormController>(
        builder: (context, controller, child) {
          return Scaffold(
            appBar: AppBar(
              title: const Text('Formulario de Adoptante'),
            ),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: List.generate(4, (index) {
                                  final isCurrentOrPast = index <= controller.currentStep;
                                  return Expanded(
                                    child: Container(
                                      height: 6,
                            ...
                            Expanded(
                              child: ListView(
                                ...
                                children: [
                                  if (controller.currentStep == 0) _buildHousingStep(controller),
                                  if (controller.currentStep == 1) _buildHouseholdStep(controller),
                                  if (controller.currentStep == 2) _buildRoutineStep(controller),
                                  if (controller.currentStep == 3) _buildCommitmentStep(controller),
                                ],
                              ),
                            ),
  ...
  Widget _buildHousingStep(AdopterFormController c) {
    return Column(
      ...
      children: [
        const Text('Tipo de vivienda:', style: TextStyle(fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
        DropdownButtonFormField<String>(
          initialValue: c.form.housingType,
          isExpanded: true,
          items: const [
            DropdownMenuItem(value: 'apartment', child: Text('Departamento / Piso', overflow: TextOverflow.ellipsis)),
            DropdownMenuItem(value: 'house', child: Text('Casa', overflow: TextOverflow.ellipsis)),
            DropdownMenuItem(value: 'farm', child: Text('Quinta / Finca', overflow: TextOverflow.ellipsis)),
        ...
        const Text('Situación de la vivienda:', style: TextStyle(fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
        DropdownButtonFormField<String>(
          initialValue: c.form.housingStatus,
          isExpanded: true,
          items: const [
            DropdownMenuItem(value: 'owned', child: Text('Propiedad Propia', overflow: TextOverflow.ellipsis)),
            DropdownMenuItem(value: 'rented_allowed', child: Text('Alquiler (Permiten mascotas)', overflow: TextOverflow.ellipsis)),
            DropdownMenuItem(
                value: 'rented_pending_permission',
                child: Text('Alquiler (Aún consultando al dueño)', overflow: TextOverflow.ellipsis)),
          ],
          onChanged: (val) => c.updateHousing(
        ...
        SwitchListTile(
          ...
          subtitle: const Text('Importante para perros de tamaño grande o alta energía.'),
        ...
        SwitchListTile(
          ...
          subtitle: const Text('Requisito indispensable para la adopción de gatos en pisos altos.'),
  ...
  Widget _buildHouseholdStep(AdopterFormController c) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text('¿Con quién vives en el hogar?:', style: TextStyle(fontWeight: FontWeight.bold)),
        const SizedBox(height: 8),
        DropdownButtonFormField<String>(
          initialValue: c.form.householdMembers,
          isExpanded: true,
          items: const [
            DropdownMenuItem(value: 'alone', child: Text('Vivo solo/a', overflow: TextOverflow.ellipsis)),
            DropdownMenuItem(value: 'couple', child: Text('En pareja', overflow: TextOverflow.ellipsis)),
            DropdownMenuItem(value: 'family_with_young_kids', child: Text('Familia con niños pequeños (<10 años)', overflow: TextOverflow.ellipsis)),
            DropdownMenuItem(value: 'family_with_teens', child: Text('Familia con adolescentes / adultos', overflow: TextOverflow.ellipsis)),
            DropdownMenuItem(value: 'roommates', child: Text('Compañeros de piso (Roommates)', overflow: TextOverflow.ellipsis)),
          ],
        ...
        const SizedBox(height: 16),
        SwitchListTile(
          title: const Text('¿Todos los miembros del hogar están de acuerdo con adoptar?'),
        ...
        SwitchListTile(
          title: const Text('¿Alguien en la casa tiene alergia a pelos de animales?'),
    ...
    return Column(
      children: [
        SwitchListTile(
          ...
          subtitle: const Text('Confirmo que puedo cubrir alimento de calidad, pipetas y controles.'),
        ...
        SwitchListTile(
          ...
          subtitle: const Text('Capacidad de responder ante una urgencia médica o imprevisto.'),
        ...
        SwitchListTile(
          ...
          subtitle: const Text('Envío de fotos periódicas y visitas acordadas con el refugio.'),
        ...
        SwitchListTile(
          ...
          subtitle: const Text('Esencial para el control ético de la sobrepoblación.'),
