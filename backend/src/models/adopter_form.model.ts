...
export const AdopterFormSchema = z.object({
  ...
  other_pets_details: z.string().max(500, 'Máximo 500 caracteres').optional().nullable(),
  previous_pet_experience: z.string().max(500, 'Máximo 500 caracteres').optional().nullable(),
